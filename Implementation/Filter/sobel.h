...
template <typename T>
void sobel(const T *img_in, size_t width, size_t height, size_t channels, T *img_out, int ksize = 3, int gaussianKsize = 3, int threshold = 0, bool gradient = false);
...
constexpr std::pair<Kernel, Kernel> sobelKernel(int ksize);
