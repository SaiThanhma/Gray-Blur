...
{   
    ...
    gaussianBlur<T, 5>(img_ingray.get(), width, height, channels,img_ingrayblur.get());
    ...
    std::array<float, 9> sx{{1.f, 0.f, -1.f, 2.f, 0.f, -2.f, 1.f, 0.f, -1.f}};
    std::array<float, 9> sy{{1.f, 2.f, 1.f, 0.f, 0.f, 0.f, -1.f, -2.f, -1.f}};
